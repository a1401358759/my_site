...
function countUp(a, b, c, d, e, f) {
    for (
        var g = 0, h = ["webkit", "moz", "ms", "o"], i = 0; i < h.length && !window.requestAnimationFrame;
        ++i
    )
    ...
    (this.start = function(a) {
        return (
            ...
            (console.log("countUp error: startVal or endVal is not a number"),
                j.printValue()) :
            (j.rAF = requestAnimationFrame(j.count)), !1
        );
    }),
    (this.stop = function() {
        ...
        return this.each(function() {
            ...
            function d() {
                M.removeClass("ps-active-x"),
                    ...
                    (Y = M.prop("scrollHeight")), !P.suppressScrollX && C > E + P.scrollXMarginOffset ?
                    ((X = !0),
                        (I = E - F),
                        (k = c(t((I * E) / C))),
            ...
            function b() {
                function e(e) {
                    ...
                    return (
                        ...
                        ((t *= 10), (o *= 10)),
                        t !== t && o !== o && ((t = 0), (o = e.originalEvent.wheelDelta)), [t, o]
                    );
                }
