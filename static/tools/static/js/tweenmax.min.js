...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        "use strict";
        _gsScope._gsDefine(
                "TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"],
                function(t, e, i) {
                    var s = function(t) {
                            var e,
                                i = [],
                        ...
                        (l.progress = function(t) {
                            return arguments.length ?
                                this.totalTime(
                                    ...
                                    this._cycle * (this._duration + this._repeatDelay), !1
                                ) :
            ...
            _gsScope._gsDefine(
                "TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"],
                function(t, e, i) {
                    var s = function(t) {
                            e.call(this, t),
                                (this._labels = {}),
                    ...
                    return (
                        ...
                        (m.add = function(r, n, a, h) {
                            ...
                            if (
                                ("number" != typeof n &&
                                    (n = this._parseTimeOrLabel(n, 0, !0, r)), !(r instanceof t))
                            ) {
                                if (r instanceof Array || (r && r.push && o(r))) {
                                    for (
                                        a = a || "normal", h = h || 0, l = n, _ = r.length, u = 0; _ > u; u++
                                    )
                                        o((p = r[u])) && (p = new s({
                                            tweens: p
                                        })),
                        ...
                        (m.render = function(t, e, i) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    for (
                                        s = this._first; s && ((a = s._next), !this._paused || d);
            ...
            _gsScope._gsDefine(
                "TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"],
                function(t, e, i) {
                    var s = function(e) {
                            t.call(this, e),
                                (this._repeat = this.vars.repeat || 0),
            ...
            (function() {
                var t = 180 / Math.PI,
                    ...
                    u = function(t, e, i) {
                        ...
                        for (l = v.length; --l > -1;) {
                            for (
                                p = v[l], m[p] = h = [], c = 0, u = t.length, _ = 0; u > _; _++
                            )
                                (s =
                                    null == i ?
                                    t[_][p] :
                        ...
                        init: function(t, e, i) {
                            ...
                            if (
                                ((this._beziers =
                                        ...
                                        _(
                                            h,
                                            isNaN(e.curviness) ? 1 : e.curviness, !1,
                                            "thruBasic" === e.type,
                                            e.correlate,
                                            o
                                        ) :
                        ...
                        e._registerComplexSpecialProp("bezier", {
                            parser: function(t, e, n, a, o, h) {
                                ...
                                return (
                                    ...
                                    (o.plugin = h),
                                    (o.setRatio = s),
                                    0 === d.autoRotate && (d.autoRotate = !0), !d.autoRotate ||
                ...
                function(t, e) {
                            ...
                            return (
                                ...
                                ((r = 360),
                                    ...
                                    (a =
                                        ...
                                        ("=" === t.charAt(1) ? 0 : e)),
                                    n.length &&
                                    (s && (s[i] = e + a), -1 !== t.indexOf("short") &&
                                        ((a %= r),
                                            a !== a % (r / 2) && (a = 0 > a ? a + r : a - r)), -1 !== t.indexOf("_cw") && 0 > a ?
                                ...
                                ("," === t.charAt(t.length - 1) &&
                                    ...
                                    (4 === t.length &&
                                        ((e = t.charAt(1)),
                                            ...
                                            (s = t.charAt(3)),
                                            (t = "#" + e + e + i + i + s + s)),
                                        (t = parseInt(t.substr(1), 16)), [t >> 16, 255 & (t >> 8), 255 & t]) :
                                    "hsl" === t.substr(0, 3) ?
                                    ((t = t.match(m)),
                                ...
                                (r = e ?
                                    function(t) {
                                        ...
                                        if ("number" == typeof t) t += u;
                                            ...
                                            for (
                                                f = t.replace(D, "|").split("|"), c = 0; f.length > c; c++
                                            )
                                                f[c] = r(f[c]);
                                            return f.join(",");
                                        }
                                    ...
                                    function(t) {
                                        ...
                                        if ("number" == typeof t) t += u;
                                            ...
                                            for (
                                                n = t.replace(D, "|").split("|"), p = 0; n.length > p; p++
                                            )
                                                n[p] = r(n[p]);
                                            return n.join(",");
                                        }
                    ...
                    (h.parseComplex = function(t, e, i, s, r, n) {
                        ...
                        if (
                            ...
                            for (
                                l = h.length > o.length ? h.length : o.length, a = 0; l > a; a++
                            )
                                (e = o[a] = o[a] || this.dflt),
                                (i = h[a] = h[a] || this.dflt),
                                p &&
                    ...
                    var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(
                                    ...
                                    if (
                                        (v.zOrigin &&
                                            ((D = -v.zOrigin),
                                                (A = S * D - n[12]),
                                                (O = k * D - n[13]),
                                                (D = R * D + v.zOrigin - n[14])), !i || s || null == v.rotationX)
                                    ) {
                                        var I,
                                            E,
                                            L,
                            ...
                            if (p) {
                                ...
                                if (
                                    (null != s.ox &&
                                        ...
                                        (u.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ?
                                            e.replace(O, w) :
                                            w + " " + e),
                                        (0 === t || 1 === t) &&
                                        1 === o &&
                        ...
                        ke = (N.set3DTransformRatio = function(t) {
                            ...
                            if (p) {
                                var L = 1e-4;
                                L > A && A > -L && (A = O = 2e-5),
                                    L > C && C > -L && (C = O = 2e-5), !E || S.z || S.rotationX || S.rotationY || (E = 0);
                            }
                            if (R || S.skewX)
                                (y = Math.cos(R)),
                                (T = Math.sin(R)),
                        ...
                        de("borderRadius", {
                            ...
                            parser: function(t, e, i, n, a) {
                                ...
                                for (
                                    ...
                                    (u = _ = W(t, b[h], r, !1, "0px")), -1 !== u.indexOf(" ") &&
                    ...
                    var Ae = function(t) {
                        ...
                        100 === r &&
                            ...
                            e ||
                            (this.xn1 && (i.filter = s = s || "alpha(opacity=" + r + ")"), -1 === s.indexOf("pacity") ?
                                (0 === r && this.xn1) ||
                        ...
                        if (
                            (_ &&
                                ...
                                ((m = x.cssText),
                                    (h = $(t, r)),
                                    (x.cssText = m + ";" + e),
                                    (h = H(t, h, $(t)).difs), !U && w.test(e) && (h.opacity = parseFloat(RegExp.$1)),
                                    (e = h),
                                    (x.cssText = m)),
                ...
                init: function(t, e) {
                    ...
                    for (i in e)
                        ...
                        ((o = (e[i] + "").split("_")),
                            ...
                            (a = n - r),
                            o.length &&
                            ((s = o.join("_")), -1 !== s.indexOf("short") &&
                                ((a %= h), a !== a % (h / 2) && (a = 0 > a ? a + h : a - h)), -1 !== s.indexOf("_cw") && 0 > a ?
    ...
    (function(t, e) {
        ...
        if (!i.TweenLite) {
            ...
            var V = function(t, e, i) {
                ...
                W = function(t, e, i) {
                    for (
                        var s = t._timeline, r = s._timeScale, n = t._startTime; s._timeline;
