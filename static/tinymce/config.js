tinyMCE.init({
  ...
  toolbar2: " searchreplace | bullist numlist | outdent indent blockquote | link unlink anchor imageupload media code | inserttime preview | forecolor backcolor | codesample",
