...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: I18N.t("This value seems to be invalid."),
  type: {
    email:        I18N.t("This value should be a valid email."),
    url:          I18N.t("This value should be a valid url."),
    number:       I18N.t("This value should be a valid number."),
    integer:      I18N.t("This value should be a valid integer."),
    digits:       I18N.t("This value should be digits."),
    alphanum:     I18N.t("This value should be alphanumeric.")
  },
  notblank:       I18N.t("This value should not be blank."),
  required:       I18N.t("This value is required."),
  pattern:        I18N.t("This value seems to be invalid."),
  min:            I18N.t("This value should be greater than or equal to %s."),
  max:            I18N.t("This value should be lower than or equal to %s."),
  range:          I18N.t("This value should be between %s and %s."),
  minlength:      I18N.t("This value is too short. It should have %s characters or more."),
  maxlength:      I18N.t("This value is too long. It should have %s characters or less."),
  length:         I18N.t("This value length is invalid. It should be between %s and %s characters long."),
  mincheck:       I18N.t("You must select at least %s choices."),
  maxcheck:       I18N.t("You must select %s choices or less."),
  check:          I18N.t("You must select between %s and %s choices."),
  equalto:        I18N.t("This value should be the same.")
});
